            ...
            <div className="space-y-8">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                  <a href="#blogs" onClick={(e) => handleScroll(e, 'blogs')} className="text-sm text-orange-800/80 hover:text-orange-900 transition-colors">Blog</a>
